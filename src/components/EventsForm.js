...
const EventsForm = () => {
  ...
  const fetchEvents = () => {
    fetch('http://ec2-52-201-73-66.compute-1.amazonaws.com:4000/api/events')
  ...
  const handleSubmit = (e) => {
    ...
    if (editingEventId) {
      fetch(`http://ec2-52-201-73-66.compute-1.amazonaws.com:4000/api/events/${editingEventId}`, {
        method: 'PUT',
        headers: {
  ...
  const handleDelete = (eventId) => {
    fetch(`http://ec2-52-201-73-66.compute-1.amazonaws.com:4000/api/events/${eventId}`, {
      method: 'DELETE'
    })
      .then(() => {
